...
|----|-------|------|-------------|---------------|--------|--------|--------|
| TD-005 | 45 | INTEGRATION | VSA planning fixed in Stage 46: subgoal extraction + position navigation, 92.5% success | plan ≥ 15% DoorKey-5x5 | CLOSED | 2026-04-02 | 2026-04-02 |
