...
| TD-004 | 43 | INTEGRATION | WM gating mechanism: sustained oscillation confirmed but FHN coupling amplifies WM noise instead of decay. Need proper gating (PE-driven, attention-based, or reward-gated) for WM to help DoorKey. | WM DoorKey success > no-WM success | `main` | OPEN | 2026-04-01 | — |
