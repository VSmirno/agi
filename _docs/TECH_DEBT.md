...
|----|-------|------|-------------|---------------|---------|--------|--------|--------|
| TD-001 | 38 | GPU_EXP | exp97 Pure DAF DoorKey-5x5 на 50K нод. Partial: exp97a=0% (FAIL), exp97b=0 modulations (FAIL), exp97c=INCOMPLETE (torch.compile hang, fixed), exp97d=PASS. Root cause: goal_embedding never set → navigator disabled. Нужен fix + перезапуск. | success_rate ≥ 0.10, modulations > 0 | `main` @ `b062a48` | IN_PROGRESS | 2026-04-01 | — |
